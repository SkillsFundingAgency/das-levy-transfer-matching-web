...
public class ContactDetailsPostRequestValidator : AbstractValidator<ContactDetailsPostRequest>
{
    ...
    private static bool ValidateAddressUniqueness(ContactDetailsPostRequest contactDetailsPostRequest, string additionalEmailAddress, ValidationContext<ContactDetailsPostRequest> validationContext)
    {
        ...
        var emailIndex = (int)validationContext.MessageFormatter.PlaceholderValues["CollectionIndex"];
